...
#if defined(CONFIG_OF) && !(defined(CONFIG_X86) && defined(MY_ABC_HERE))
...
#else /* defined(CONFIG_OF) && !(defined(CONFIG_X86) && defined(MY_ABC_HERE)) */
...
#endif /* defined(CONFIG_OF) && !(defined(CONFIG_X86) && defined(MY_ABC_HERE */
