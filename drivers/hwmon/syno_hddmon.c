...
#if defined(CONFIG_SYNO_CEDARVIEW) || defined(CONFIG_ARCH_GEN3) || defined(CONFIG_SYNO_ARMADA) || defined(CONFIG_SYNO_ARMADA_V2) || defined(CONFIG_ARCH_COMCERTO) || defined(CONFIG_SYNO_AVOTON) ||  defined(CONFIG_SYNO_ALPINE) || defined(MY_ABC_HERE)
