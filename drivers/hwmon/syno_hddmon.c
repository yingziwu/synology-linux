...
#if defined(MY_DEF_HERE) || defined(CONFIG_ARCH_GEN3) || defined(MY_ABC_HERE) || defined(MY_DEF_HERE) || defined(CONFIG_ARCH_COMCERTO) || defined(MY_DEF_HERE) ||  defined(MY_DEF_HERE)
