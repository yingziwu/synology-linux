...
#if IS_ENABLED(CONFIG_USB_DWC3_RTK) && (defined(MY_ABC_HERE) || defined(CONFIG_SYNO_LSP_RTD1619))
	/* fixed kernel panic when init usb2_phy
	 * move to the end of function
	 */
#else /* CONFIG_USB_DWC3_RTK && (MY_ABC_HERE || CONFIG_SYNO_LSP_RTD1619) */
	usb_phy_init(dwc->usb2_phy);
#endif /* CONFIG_USB_DWC3_RTK && (MY_ABC_HERE || CONFIG_SYNO_LSP_RTD1619) */
...
#if defined(CONFIG_USB_RTK_DWC3_DRD_MODE) && (defined(MY_ABC_HERE) || defined(CONFIG_SYNO_LSP_RTD1619))
...
#endif
#endif /* CONFIG_USB_RTK_DWC3_DRD_MODE || (MY_ABC_HERE || CONFIG_SYNO_LSP_RTD1619) */
...
#else /* defined(CONFIG_USB_PATCH_ON_RTK) && defined(MY_ABC_HERE) */
