...
#define SYNO_HUB_POWER_CYCLE_EXTRA_DELAY_TIME	(10000)		//ms
#else
...
#if defined(MY_DEF_HERE)
	if (status == -ENODEV || status == -ENOTSUPP)
#else /* MY_DEF_HERE */
...
#endif /* (CONFIG_PM && !CONFIG_SYNO_LSP_HI3536) || (CONFIG_SYNO_LSP_HI3536 && CONFIG_USB_SUSPEND) */
...
#endif /* (CONFIG_PM_RUNTIME && !CONFIG_SYNO_LSP_HI3536) || (CONFIG_SYNO_LSP_HI3536 && CONFIG_USB_SUSPEND) */
...
#endif /* CONFIG_SYNO_LSP_HI3536 && !CONFIG_USB_SUSPEND */
