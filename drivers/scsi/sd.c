...
#elif defined(MY_ABC_HERE) /* MY_ABC_HERE */
static DEFINE_IDA(usb_index_ida);
...
#endif /* MY_ABC_HERE || (defined(MY_ABC_HERE) && defined(MY_ABC_HERE)) */
#ifdef MY_ABC_HERE
...
#endif /* MY_DEF_HERE || defined(MY_ABC_HERE) || defined(MY_ABC_HERE) */
