...
#else /* CONFIG_SYNO_LSP_HI3536 && CONFIG_ARCH_HI3531A */
	writel(1 << port_no, mmio + HOST_IRQ_STAT);
#endif /* CONFIG_SYNO_LSP_HI3536 && CONFIG_ARCH_HI3531A */
}
...
#else /* CONFIG_SYNO_LSP_HI3536 && CONFIG_HI_SATA_RAM */
	cmd_tbl_dma = pp->cmd_tbl_dma + tag * AHCI_CMD_TBL_SZ;
#endif /* CONFIG_SYNO_LSP_HI3536 && CONFIG_HI_SATA_RAM */
...
#else /* MY_ABC_HERE || CONFIG_SYNO_LSP_HI3536 */
		if ((fbs & PORT_FBS_SDE) && (pmp < ap->nr_pmp_links) &&
		    ata_link_online(&ap->pmp_link[pmp])) {
#endif /* MY_ABC_HERE || CONFIG_SYNO_LSP_HI3536 */
