...
#else /* CONFIG_SYNO_LSP_HI3536 && (CONFIG_ARCH_HI3536 || CONFIG_ARCH_HI3521A || CONFIG_ARCH_HI3531A) */
static void __init gic_dist_init(struct gic_chip_data *gic)
{
	unsigned int i;
	u32 cpumask;
...
#endif /* CONFIG_SYNO_LSP_HI3536 && (CONFIG_ARCH_HI3536 || CONFIG_ARCH_HI3521A || CONFIG_ARCH_HI3531A) */
