				       ...
				       struct device_node *parent)
{
	...
	data->domain = irq_domain_add_simple(node, 32, info->first_irq, &realtek_mux_irq_domain_ops, data);
	if (!data->domain) {
		kfree(data);
		return -ENOMEM;
	}
...
IRQCHIP_DECLARE(rtd13xx_iso_mux, "realtek,rtd13xx-iso-irq-mux", realtek_irq_mux_init);
IRQCHIP_DECLARE(rtd13xx_misc_mux, "realtek,rtd13xx-misc-irq-mux", realtek_irq_mux_init);
IRQCHIP_DECLARE(rtd16xxb_iso_mux, "realtek,rtd16xxb-iso-irq-mux", realtek_irq_mux_init);
IRQCHIP_DECLARE(rtd16xxb_misc_mux, "realtek,rtd16xxb-misc-irq-mux", realtek_irq_mux_init);
