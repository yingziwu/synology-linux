...
typedef struct _tag_SYNO_PCIE_DEV_SKIP_DMAR {
	const char *szName;    /* name of PCIe device, or NULL for list end */
	const unsigned short iVendor; /* vendor ID */
	const unsigned short iDevice; /* device ID */
