...
#if defined(CONFIG_SYNO_MPC85XX_COMMON) || defined(MY_DEF_HERE) || defined(MY_ABC_HERE)
		/* To avoid mapping the whole flash in mtd0 */
		iounmap(info->map[i].virt);
		return 0;
#endif /* defined(CONFIG_SYNO_MPC85XX_COMMON) || defined(MY_DEF_HERE) || defined(MY_ABC_HERE) */
