...
#ifdef PX_SOC_ARMADA370
struct resource pmu_resource_armada370[] = {
        [0] = {
                .start  = IRQ_AURORA_MP,
                .end    = IRQ_AURORA_MP,
                .flags  = IORESOURCE_IRQ,
...
#ifdef PX_SOC_ARMADA370
	*pmu_resource      = pmu_resource_armada370;
	*pmu_resource_num  = ARRAY_SIZE(pmu_resource_armada370);
	return 0;
#endif
