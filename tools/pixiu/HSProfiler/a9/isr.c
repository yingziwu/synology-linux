                              ...
                              unsigned long long ts)
{
	...
	if (flag_value == 0)
	{
//		printk(KERN_EMERG "[CPA] flag_value == 0\n");
		return IRQ_NONE;
	}
...
//	printk(KERN_EMERG "in px_hotspot_isr , ret is : %d \n", ret);
...
//	printk(KERN_EMERG "[CPA] in start_ebs, before call stop_pmu firstly\n");
//	on_each_cpu(stop_pmu, NULL, 1);
//	printk(KERN_EMERG "[CPA] in start_ebs, after call stop_pmu firstly\n");
