...
asmlinkage int px_sys_munmap(unsigned int addr, unsigned int len)
{
	int ret = 0;
	int saved_r5;
	unsigned long long ts;
...
//	px_original_sys_munmap     = (sys_munmap_t) xchg(&system_call_table[__NR_munmap - __NR_SYSCALL_BASE], px_sys_munmap);
...
static int remove_os_hooks(void)
{
	...
	system_call_table[__NR_vfork - __NR_SYSCALL_BASE] = px_original_sys_vfork;

	system_call_table[__NR_clone - __NR_SYSCALL_BASE] = px_original_sys_clone;

	system_call_table[__NR_execve - __NR_SYSCALL_BASE] = px_original_sys_execve;

	system_call_table[__NR_mmap- __NR_SYSCALL_BASE] = px_original_sys_mmap;

	system_call_table[__NR_mmap2 - __NR_SYSCALL_BASE] = px_original_sys_mmap2;

	//system_call_table[__NR_munmap - __NR_SYSCALL_BASE] = px_original_sys_munmap;

	system_call_table[__NR_exit - __NR_SYSCALL_BASE] = px_original_sys_exit;

	system_call_table[__NR_exit_group - __NR_SYSCALL_BASE] = px_original_sys_exit_group;

	system_call_table[__NR_kill - __NR_SYSCALL_BASE] = px_original_sys_kill;

	system_call_table[__NR_tkill - __NR_SYSCALL_BASE] = px_original_sys_tkill;

	system_call_table[__NR_tgkill - __NR_SYSCALL_BASE] = px_original_sys_tgkill;

	system_call_table[__NR_prctl - __NR_SYSCALL_BASE] = px_original_sys_prctl;
...
//		orgFn = xchg(&system_call_table[__NR_munmap - __NR_SYSCALL_BASE], orgFn);
