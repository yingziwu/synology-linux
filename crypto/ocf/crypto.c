...
#if (defined(MY_DEF_HERE) && (defined(CONFIG_MV_CESA_OCF) || defined(CONFIG_MV_CESA_OCF_KW2))) || \
	(defined(MY_DEF_HERE) && defined(CONFIG_MV_CESA))
...
#elif defined(MY_DEF_HERE) && defined(CONFIG_OF) && defined(CONFIG_MV_INCLUDE_CESA)
