...
#ifdef MY_ABC_HERE
asmlinkage long sys_syno_notify_init(unsigned int event_f_flags);
asmlinkage long sys_syno_notify_add_watch(int synotify_fd, const char  __user *pathname, u64 mask);
asmlinkage long sys_syno_notify_remove_watch(int synotify_fd, const char  __user *pathname, u64 mask);
asmlinkage long sys_syno_notify_add_watch32(int synotify_fd, const char  __user *pathname, u32 mask);
asmlinkage long sys_syno_notify_remove_watch32(int synotify_fd, const char  __user *pathname, u32 mask);
...
#endif /* MY_ABC_HERE */
#ifdef MY_ABC_HERE
asmlinkage long sys_syno_archive_overwrite(unsigned int fd, unsigned int flags);
