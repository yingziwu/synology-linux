...
#define CRUSH_ITEM_LEAF_FAIL  0x7ffffffd  /* leaf fail result (internal use only) */
...
#ifdef CONFIG_SYNO_CEPH_CUSTOMIZED_CRUSH
	,
	CRUSH_RULE_SET_SYNO_CHOOSE_PRIMARY = 31,
	CRUSH_RULE_SYNO_ENUM = 32,
	CRUSH_RULE_SYNO_CHOOSE_FIRSTN = 33,
	CRUSH_RULE_SYNO_CHOOSE_INDEP = 34,
	CRUSH_RULE_SYNO_CHOOSELEAF_FIRSTN = 35,
	CRUSH_RULE_SYNO_CHOOSELEAF_INDEP = 36,
#endif /* CONFIG_SYNO_CEPH_CUSTOMIZED_CRUSH */
};
