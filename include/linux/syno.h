...
/**
 * Fix: DSM #105242
 * Dsc: Forcely increase sb event during starting and stopping array
 */
 ...
 */
#if defined(MY_ABC_HERE) && defined(MY_ABC_HERE)
#if defined(CONFIG_SYNO_X86) || defined(MY_DEF_HERE) || defined(CONFIG_SYNO_MV88F6281) || defined(SYNO_MARVELL_88F6281) || defined(CONFIG_SYNO_ARMADA) || defined(CONFIG_SYNO_ARMADA_V2) || defined(CONFIG_SYNO_ALPINE) || defined(MY_ABC_HERE)
/* one item is Nxxxx */
 ...
 */
/* #define SYNO_E1000_PHY_RESET_WORKAROUND */
