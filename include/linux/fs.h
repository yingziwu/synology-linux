...
struct vfsmount;
struct cred;
#if defined(MY_DEF_HERE) || defined(MY_DEF_HERE) || (defined(MY_DEF_HERE) && defined(CONFIG_COMCERTO_IMPROVED_SPLICE))
struct socket;
#endif
...
extern int do_aggregate_recvfile_flush(int fd);
#endif /* MY_ABC_HERE */
#endif
...
#ifdef MY_ABC_HERE
#define SYNO_BTRFS_MOUNT_PATH_LEN 128
#endif
