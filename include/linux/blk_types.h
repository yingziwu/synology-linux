...
#ifdef MY_ABC_HERE
/*
 * Tell under layer to get the redundant version for this block.
 */
...
#define REQ_COMMON_MASK \
	(REQ_WRITE | REQ_FAILFAST_MASK | REQ_SYNC | REQ_META | REQ_PRIO | \
	 ...
	 REQ_SECURE | REQ_UNUSED_HINT | REQ_NOMERGE)
#else /* MY_ABC_HERE */
#define REQ_COMMON_MASK \
	(REQ_WRITE | REQ_FAILFAST_MASK | REQ_SYNC | REQ_META | REQ_PRIO | \
	 REQ_DISCARD | REQ_WRITE_SAME | REQ_NOIDLE | REQ_FLUSH | REQ_FUA | \
...
#ifdef  MY_ABC_HERE
#define BIO_NO_ADVANCE_ITER_MASK	(REQ_DISCARD|REQ_WRITE_SAME|REQ_UNUSED_HINT)
#else /* MY_ABC_HERE */
