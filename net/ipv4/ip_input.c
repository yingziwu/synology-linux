...
int gWifiStaNum = 0;
EXPORT_SYMBOL(gWifiStaNum);

atomic_t syno_ppp_unit_count = ATOMIC_INIT(0);
EXPORT_SYMBOL(syno_ppp_unit_count);

atomic_t syno_ppp_channel_count = ATOMIC_INIT(0);
EXPORT_SYMBOL(syno_ppp_channel_count);
