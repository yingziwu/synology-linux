...
#endif
#ifdef MY_ABC_HERE
SYSCALL(SYNOMTDAlloc)		 
#else
SYSCALL(ni_syscall)
#endif
#ifdef MY_ABC_HERE
SYSCALL(SYNOCaselessStat64)             
SYSCALL(SYNOCaselessLStat64)            
#else
SYSCALL(ni_syscall)
SYSCALL(ni_syscall)
#endif  
...
SYSCALL(ni_syscall)                     
#ifdef MY_ABC_HERE
SYSCALL(SYNOEcryptName)		 
SYSCALL(SYNODecryptName)	 
#else
SYSCALL(ni_syscall)			 
SYSCALL(ni_syscall)
#endif
#ifdef MY_ABC_HERE
SYSCALL(SYNOACLCheckPerm)		 
SYSCALL(SYNOACLIsSupport)		 
SYSCALL(SYNOACLGetPerm)		     
#else
SYSCALL(ni_syscall)			 	
SYSCALL(ni_syscall)			
SYSCALL(ni_syscall)
...
SYSCALL(SYNONotifyAddWatch32)  
SYSCALL(SYNONotifyRemoveWatch32)  
#else
SYSCALL(ni_syscall)  
SYSCALL(ni_syscall)  
SYSCALL(ni_syscall)  
