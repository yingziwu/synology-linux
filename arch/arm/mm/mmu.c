...
#include <asm/traps.h>
     ...
     (defined(MY_ABC_HERE) && defined(CONFIG_MV_SUPPORT_64KB_PAGE_SIZE) && defined(CONFIG_HIGHMEM))
...
#if (defined(MY_ABC_HERE) || defined(MY_DEF_HERE)) && (defined (CONFIG_CPU_SHEEVA_PJ4B_V6) || defined(CONFIG_CPU_SHEEVA_PJ4B_V7))
#else
	/*
...
#if (defined(MY_ABC_HERE) || defined(MY_DEF_HERE)) && defined(CONFIG_ARM_LPAE)
...
#if (defined(MY_ABC_HERE)|| defined(MY_DEF_HERE)) && (defined(CONFIG_SMP) || defined (CONFIG_AURORA_IO_CACHE_COHERENCY))
#else
	if (is_smp())
#endif
...
#endif
#else
#if defined(MY_ABC_HERE) && (defined(CONFIG_SMP) || defined (CONFIG_SHEEVA_ERRATA_ARM_CPU_5114) || \
...
static pte_t * __init early_pte_alloc(pmd_t *pmd, unsigned long addr, unsigned long prot)
{
	if (pmd_none(*pmd)) {
     ...
     (defined(MY_ABC_HERE) && defined(CONFIG_MV_SUPPORT_64KB_PAGE_SIZE))
...
#if (defined(MY_ABC_HERE) || defined(MY_DEF_HERE)) && defined(CONFIG_FB_DOVE)
...
#if (defined(MY_ABC_HERE) || defined(CONFIG_SYNO_ARMADA_ARCH_v2)) && defined(ARCH_PLAT_ARMADA)
#else
#ifdef CONFIG_HIGHMEM
	if (highmem) {
...
#if defined(MY_DEF_HERE) && defined(CONFIG_COMCERTO_ZONE_DMA_NCNB)
