...
#if (defined(MY_DEF_HERE) || defined(MY_ABC_HERE)) && (defined (CONFIG_CPU_SHEEVA_PJ4B_V6) || defined(CONFIG_CPU_SHEEVA_PJ4B_V7))
#else
	/*
...
#if (defined(MY_DEF_HERE) || defined(MY_ABC_HERE)) && defined(CONFIG_ARM_LPAE)
...
#if (defined(MY_DEF_HERE)|| defined(MY_ABC_HERE)) && (defined(CONFIG_SMP) || defined (CONFIG_AURORA_IO_CACHE_COHERENCY))
#else
	if (is_smp())
#endif
...
#if (defined(MY_DEF_HERE) || defined(MY_ABC_HERE)) && defined(CONFIG_FB_DOVE)
