...
#if defined(MY_DEF_HERE) || deinfed(MY_DEF_HERE)
 *     flush_kern_louis()
 *
 ...
 */
#if (defined(MY_ABC_HERE) || defined(MY_DEF_HERE)) && (defined (CONFIG_CACHE_AURORA_L2) && defined (CONFIG_AURORA_L2_OUTER) && !defined (CONFIG_AURORA_L2_PT_WALK))
