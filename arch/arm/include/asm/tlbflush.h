...
#if (defined(MY_DEF_HERE) || defined(MY_ABC_HERE)) && (defined (CONFIG_ARCH_ARMADA_XP) && !defined (CONFIG_AURORA_L2_PT_WALK))
...
#if (defined(MY_DEF_HERE) || defined(MY_ABC_HERE)) && defined(CONFIG_CACHE_AURORA_L2)
...
#if defined(MY_ABC_HERE) && (defined(CONFIG_MV_LARGE_PAGE_SUPPORT) && !defined(CONFIG_MV_64KB_MMU_PAGE_SIZE_SUPPORT))
	if (tlb_flag(TLB_WB))
		dsb();
 ...
 *	PMD entries.
 */
#if !defined(MY_DEF_HERE) || !defined(CONFIG_COMCERTO_64K_PAGES)
static inline void flush_pmd_entry(void *pmd)
{
	const unsigned int __tlb_flag = __cpu_tlb_flags;

	if (tlb_flag(TLB_DCLEAN))
#if (defined(MY_DEF_HERE)||defined(MY_ABC_HERE)) && defined(CONFIG_SHEEVA_ERRATA_ARM_CPU_4611)
	{
		unsigned long flags;
        	raw_local_irq_save(flags);
		dmb();
#endif
#if (defined(MY_DEF_HERE) || defined(MY_ABC_HERE)) && (defined(CONFIG_SHEEVA_ERRATA_ARM_CPU_6043) || defined(CONFIG_SHEEVA_ERRATA_ARM_CPU_6124))
