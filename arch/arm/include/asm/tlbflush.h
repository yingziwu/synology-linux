...
#if (defined(MY_ABC_HERE) || defined(MY_DEF_HERE)) && (defined (CONFIG_ARCH_ARMADA_XP) && !defined (CONFIG_AURORA_L2_PT_WALK))
...
#if (defined(MY_ABC_HERE) || defined(MY_DEF_HERE)) && defined(CONFIG_CACHE_AURORA_L2)
...
#if (defined(MY_ABC_HERE)||defined(MY_DEF_HERE)) && defined(CONFIG_SHEEVA_ERRATA_ARM_CPU_4611)
	{
		unsigned long flags;
        	raw_local_irq_save(flags);
		dmb();
#endif
#if (defined(MY_ABC_HERE) || defined(MY_DEF_HERE)) && (defined(CONFIG_SHEEVA_ERRATA_ARM_CPU_6043) || defined(CONFIG_SHEEVA_ERRATA_ARM_CPU_6124))
