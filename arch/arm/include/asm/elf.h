...
#if defined(MY_ABC_HERE) || (defined(MY_DEF_HERE) && defined(CONFIG_MV_LARGE_PAGE_SUPPORT))
#define ELF_EXEC_PAGESIZE	PAGE_SIZE
#else /* MY_ABC_HERE || (MY_DEF_HERE && CONFIG_MV_LARGE_PAGE_SUPPORT) */
#define ELF_EXEC_PAGESIZE	4096
#endif /* MY_ABC_HERE || (MY_DEF_HERE && CONFIG_MV_LARGE_PAGE_SUPPORT) */
