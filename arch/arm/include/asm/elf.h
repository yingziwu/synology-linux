...
#if defined(MY_DEF_HERE) || (defined(MY_DEF_HERE) && defined(CONFIG_MV_LARGE_PAGE_SUPPORT))
#define ELF_EXEC_PAGESIZE	PAGE_SIZE
#else /* MY_DEF_HERE || (MY_DEF_HERE && CONFIG_MV_LARGE_PAGE_SUPPORT) */
#define ELF_EXEC_PAGESIZE	4096
#endif /* MY_DEF_HERE || (MY_DEF_HERE && CONFIG_MV_LARGE_PAGE_SUPPORT) */
