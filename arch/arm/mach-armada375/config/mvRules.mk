...
A375_FAM_DIR	= armada_375_family
SOC_DEVICE_DIR	= $(A375_FAM_DIR)/device
SOC_CPU_DIR	= $(A375_FAM_DIR)/cpu
BOARD_ENV_DIR	= $(A375_FAM_DIR)/boardEnv
SOC_ENV_DIR	= $(A375_FAM_DIR)/ctrlEnv
SOC_SYS_DIR	= $(A375_FAM_DIR)/ctrlEnv/sys
...
LSP_PATH_I	= $(srctree)/arch/arm/mach-armada375
...
A375_FAM_PATH	= -I$(LSP_PATH_I)/$(A375_FAM_DIR)
...
EXTRA_INCLUDE	= $(OSSERV_PATH) $(COMMON_PATH) $(HAL_PATH)  $(A375_FAM_PATH) \
