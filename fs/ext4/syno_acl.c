 ...
 */
static size_t
ext4_xattr_list_syno_acl_access(const struct xattr_handler *handler,
...
static int
ext4_xattr_get_syno_acl(const struct xattr_handler *handler,
...
static int
ext4_xattr_set_syno_acl(const struct xattr_handler *handler,
		        struct dentry *dentry, const char *name,
