 ...
 * i_syno_archive_bit which is at the end of ext4_inode. We also increase
 * i_extra_isize from 28 to 32 for i_syno_archive_bit.
 */
...
{
#ifdef MY_ABC_HERE
	if (!is_syno_ext(inode->i_sb) && !EXT4_HAS_COMPAT_FEATURE(inode->i_sb, EXT4_FEATURE_COMPAT_DIR_INDEX))
#else
