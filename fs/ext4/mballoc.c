...
#else /* CONFIG_SYNO_LSP_HI3536 || MY_ABC_HERE */
...
#endif /* CONFIG_SYNO_LSP_HI3536 || MY_ABC_HERE */
{
...
#if defined(CONFIG_SYNO_LSP_HI3536) || defined(MY_ABC_HERE)
	switch (act) {
#ifdef CONFIG_SYNO_LSP_HI3536
	case TRIM_SEND_SEC_DISCARD:
		ret = ext4_issue_discard(sb, group, start, count, BLKDEV_DISCARD_SECURE);
		break;
#endif /* CONFIG_SYNO_LSP_HI3536 */
#ifdef MY_ABC_HERE
	case TRIM_SEND_HINT:
	...
	case TRIM_SEND_TRIM:
#ifdef CONFIG_SYNO_LSP_HI3536
		ret = ext4_issue_discard(sb, group, start, count, 0);
#else /* CONFIG_SYNO_LSP_HI3536 */
