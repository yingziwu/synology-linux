...
int hfsplus_cat_build_key(struct super_block *sb,
		hfsplus_btree_key *key, u32 parent, struct qstr *str, int nfc)
#else
int hfsplus_cat_build_key(struct super_block *sb,
...
#ifdef MY_ABC_HERE
	err = hfsplus_cat_build_key(sb, fd.search_key, dir->i_ino, str, 0);
#else
