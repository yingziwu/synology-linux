...
#ifdef MY_ABC_HERE
int ecryptfs_encrypt_extent_export(struct page *enc_page,
				   void *crypt_stat,
				   struct page *page)
{
	return ecryptfs_encrypt_extent(enc_page, (struct ecryptfs_crypt_stat *) crypt_stat,
	      page, 0);
}
EXPORT_SYMBOL(ecryptfs_encrypt_extent_export);
#endif
